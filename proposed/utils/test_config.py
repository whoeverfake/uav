...
def get_config():
    ...
    parser.add_argument("--single_eval", action='store_true', default=True,
                        help="whether to evaluate")  # 是否进行单次evaluate
    ...
    # pretrained parameters
    parser.add_argument("--model_dir", type=str, default=r'C:\Users\Administrator.DESKTOP-MIPDGKQ\Desktop\helps\MUAV-MDRL_final_files\proposed\results_proposed\results_a63_rnn/models',
