...
def get_config():
    ...
    parser.add_argument("--share_policy", action='store_false',
                        default=True, help='Whether agent share the same policy')  #default=True代表选择中心化训练，而不是所有智能体共享actor-critic网络
    ...
    # pretrained parameters
    # parser.add_argument("--model_dir", type=str, default=r'C:\Users\Administrator.DESKTOP-MIPDGKQ\Desktop\helps\results_final\results_a6_u200/models',
